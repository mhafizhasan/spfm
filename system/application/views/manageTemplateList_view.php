...
$("document").ready(function() {
    $('#uploadifyit').uploadify({
            ...
            'onAllComplete': function(event,data){
                <?php 
                $base = base_url();
                $lasturl = $this->session->flashdata('lasturl'); ?>
                window.location.href='<?php echo $base.$lasturl; ?>';
            }
        });    
    });
...
<div class="span-15">
	<h4><?php echo anchor('manage/template','TEMPLATE FAIL MEJA'); ?> &gt;&gt; <?php echo anchor($lasturl,strtoupper($title)); ?></h4>
		<br class="clear"/>
		<div class="content">
				...
				<table class="data" width="100%" cellpadding="0" cellspacing="0">
					...
					?>
						<tr>
							...
							<td>
								<a href="<?php echo base_url(); ?>popup/confirmation/template/<?php echo $bab; ?>/<?php echo $row['fid']; ?>/<?php echo $title; ?>" rel="facebox" ><img title="Hapus" src="<?php echo base_url(); ?>img/delete.png" /></a>
							</td>
						</tr>
					<?php } ?>
					</tbody>
			...
			<?php } ?>
			<!-- End bar chart table-->
			<?php echo form_open_multipart("updatefile/uploadfilex");?>
